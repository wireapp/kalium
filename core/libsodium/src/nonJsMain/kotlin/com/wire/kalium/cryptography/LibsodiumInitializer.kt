...
import com.ionspin.kotlin.crypto.LibsodiumInitializer as IonspinLibsodiumInitializer

public actual object LibsodiumInitializer {

    public actual suspend fun initializeLibsodiumIfNeeded() {
        if (!IonspinLibsodiumInitializer.isInitialized()) {
            try {
                IonspinLibsodiumInitializer.initialize()
