...
private const val SYNC_OUTBOX_REPEAT_INTERVAL: Long = 5 // execute every 5 minutes
private const val SYNC_OUTBOX_FLEX_INTERVAL: Long = 2 // 2-minute flex interval for battery optimization
