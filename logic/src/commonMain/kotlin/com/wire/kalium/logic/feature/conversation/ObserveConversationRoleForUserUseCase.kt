...
/**
 * Observes the target user's and self user's roles in a conversation.
 * Team admins are treated as conversation admins in channels owned by their team.
 */
public class ObserveConversationRoleForUserUseCase internal constructor(
    private val observeConversationMembers: ObserveConversationMembersUseCase,
    private val observeConversationDetails: ObserveConversationDetailsUseCase,
    private val observeSelfUser: ObserveSelfUserUseCase,
) {
    public suspend operator fun invoke(conversationId: ConversationId, userId: UserId): Flow<ConversationRoleData> =
        combine(
            observeSelfUser(),
...
public data class ConversationRoleData(
