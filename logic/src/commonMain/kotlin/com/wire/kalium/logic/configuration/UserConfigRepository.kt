...
interface UserConfigRepository {
    ...
    suspend fun setSimplifiedConnectionRequestEnabled(enabled: Boolean): Either<StorageFailure, Unit>
...
internal class UserConfigDataSource internal constructor(
    ...
    override suspend fun setSimplifiedConnectionRequestEnabled(enabled: Boolean): Either<StorageFailure, Unit> =
        wrapStorageRequest {
            userConfigDAO.setSimplifiedConnectionRequestEnabled(enabled)
        }

    override suspend fun isSimplifiedConnectionRequestEnabled(): Boolean = userConfigDAO.isSimplifiedConnectionRequestEnabled()
