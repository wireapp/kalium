 ...
 */
internal interface RenameConversationUseCase {
    /**
...
internal sealed class RenamingResult {
    internal data object Success : RenamingResult()
    internal data class Failure(val coreFailure: CoreFailure) : RenamingResult()
}
