 ...
 */
@Mockable
internal interface ValidateSSOCodeUseCase {
    /**
...
internal sealed class ValidateSSOCodeResult {
    internal data class Valid(val uuid: String) : ValidateSSOCodeResult()
    internal data object Invalid : ValidateSSOCodeResult()
}
