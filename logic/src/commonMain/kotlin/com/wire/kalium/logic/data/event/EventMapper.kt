...
class EventMapper(
    ...
    private fun featureConfig(
        ...
        is FeatureConfigData.MLSE2EId -> Event.FeatureConfig.MLSE2EIdUpdated(
            id,
            transient,
            featureConfigMapper.fromDTO(featureConfigUpdatedDTO.data as FeatureConfigData.MLSE2EId)
        )
