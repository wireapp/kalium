...
public interface KaliumFileSystem {
     ...
     */
    public fun sink(outputPath: Path, mustCreate: Boolean = false): Sink
     ...
     */
    public fun source(inputPath: Path): Source
     ...
     */
    public fun createDirectory(dir: Path, mustCreate: Boolean = false)
     ...
     */
    public fun delete(path: Path, mustExist: Boolean = false)
     ...
     */
    public fun deleteContents(dir: Path, mustExist: Boolean = false)
     ...
     */
    public fun copy(sourcePath: Path, targetPath: Path)
     ...
     */
    public fun tempFilePath(pathString: String? = null): Path
     ...
     */
    public suspend fun writeData(outputSink: Sink, dataSource: Source): Long
