 ...
 */
internal class SetVideoPreviewUseCase internal constructor(private val flowManagerService: FlowManagerService) {

    /**
     * @param conversationId the id of the conversation.
     * @param view the target view to set the video preview on or off.
     */
    internal suspend operator fun invoke(conversationId: ConversationId, view: PlatformView) {
