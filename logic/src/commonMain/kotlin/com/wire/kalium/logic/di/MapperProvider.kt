...
internal object MapperProvider {
    ...
    fun eventMapper(): EventMapper = EventMapper(idMapper(), connectionStatusMapper())
    ...
    fun connectionMapper(): ConnectionMapper = ConnectionMapperImpl(idMapper(), connectionStatusMapper())
}
