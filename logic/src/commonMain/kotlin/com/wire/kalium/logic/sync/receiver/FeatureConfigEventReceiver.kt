...
internal class FeatureConfigEventReceiverImpl internal constructor(
    ...
    private val simplifiedConnectionRequestConfigHandler: SimplifiedConnectionRequestConfigHandler,
    ...
    private suspend fun handleFeatureConfigEvent(event: Event.FeatureConfig): Either<CoreFailure, Unit> =
        when (event) {
            ...
            is Event.FeatureConfig.SimplifiedConnectionRequestConfigUpdated ->
                simplifiedConnectionRequestConfigHandler.handle(event.model)
        }
}
