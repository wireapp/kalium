...
/**
 * This use case will observe and return the [Flow] of [ConversationDetailsWithEvents] for a specific [ConversationId].
 */
class ObserveConversationDetailsWithEventsUseCase(
    private val conversationRepository: ConversationRepository,
    private val dispatcher: KaliumDispatcher = KaliumDispatcherImpl
) {
    sealed class Result {
        data class Success(val conversationDetailsWithEvents: ConversationDetailsWithEvents) : Result()
