...
class EnrollE2EIUseCaseImpl internal constructor(
    ...
    override suspend fun initialEnrollment(): Either<CoreFailure, E2EIEnrollmentResult> {
        ...
        val oAuthTarget =
            "https://idp.hogwash.work:5556/dex"// todo: replace with authzResponse.first.wireOidcChallenge!!.target after it fixed

        val initializationResult =
            E2EIEnrollmentResult.Initialized(oAuthTarget, authzResponse.first, authzResponse.second, newOrderResponse.third)
    ...
    override suspend fun finalizeEnrollment(
        ...
        val dpopToken = e2EIRepository.getDPoPToken(wireNonce).fold({
            ...
            kaliumLogger.e("getDPoPToken:" + it.toString())
            it
        })
        ...
        val wireAccessToken = e2EIRepository.getWireAccessToken(dpopToken).fold({
            ...
            kaliumLogger.e("getWireAccessToken:" + it.toString())
            it
        })
        ...
        val dpopChallengeResponse = e2EIRepository.validateDPoPChallenge(
            ...
            kaliumLogger.e("validateDPoPChallenge:" + it.toString())
            it
        })
        ...
        val oidcChallengeResponse = e2EIRepository.validateOIDCChallenge(
            ...
            kaliumLogger.e("validateOIDCChallenge:" + it.toString())
            it
        })
        ...
        val orderResponse = e2EIRepository.checkOrderRequest(orderLocation, prevNonce).fold({
            ...
            kaliumLogger.e("checkOrderRequest:" + it.toString())
            it
        })
        ...
        val finalizeResponse = e2EIRepository.finalize(orderResponse.second, prevNonce).fold({
            ...
            kaliumLogger.e("finalize:" + it.toString())
            it
        })
        ...
        val certificateRequest = e2EIRepository.certificateRequest(finalizeResponse.second, prevNonce).fold({
            ...
            kaliumLogger.e("certificateRequest:" + it.toString())
            it
        })
