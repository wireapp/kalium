...
interface IdMapper {
    ...
    fun fromUserIdToDao(userId: UserId) : PersistenceQualifiedId
}
...
internal class IdMapperImpl : IdMapper {
    ...
    override fun fromUserIdToDao(userId: UserId) =  PersistenceQualifiedId(value = userId.value, domain = userId.domain)
}
