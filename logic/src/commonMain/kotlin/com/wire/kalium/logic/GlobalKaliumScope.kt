...
import com.wire.kalium.logic.feature.user.ObserveSelfUsersListUseCase
import com.wire.kalium.logic.feature.user.ObserveSelfUsersListUseCaseImpl
...
class GlobalKaliumScope(
    ...
    val observeSelfUsersList: ObserveSelfUsersListUseCase
        get() = ObserveSelfUsersListUseCaseImpl(sessionRepository, userSessionScopeProvider.value)
