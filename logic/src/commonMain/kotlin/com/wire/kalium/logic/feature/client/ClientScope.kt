...
class ClientScope(
    ...
    val getOrRegisterClientUseCase: GetOrRegisterClientUseCase
        get() = GetOrRegisterClientUseCaseImpl(observeCurrentClientId, selfClients, register, clearClientData, proteusClient)
}
