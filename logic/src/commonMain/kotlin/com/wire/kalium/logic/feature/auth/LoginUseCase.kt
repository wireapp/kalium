...
internal sealed class AuthenticationResult {
    ...
    internal sealed class Failure : AuthenticationResult() {
        internal data object SocketError : Failure()
        internal sealed class InvalidCredentials : Failure() {
             ...
             */
            internal data object InvalidPasswordIdentityCombination : InvalidCredentials()
        }

        /**
         * The user has entered a text that isn't considered a valid email or handle
         */
        internal data object InvalidUserIdentifier : Failure()

        /**
         * The user's account has been suspended, for instance via backoffice
         */
        internal data object AccountSuspended : Failure()

        /**
         * The user has been invited to a team but hasn't accepted the invitation yet
         */
        internal data object AccountPendingActivation : Failure()
