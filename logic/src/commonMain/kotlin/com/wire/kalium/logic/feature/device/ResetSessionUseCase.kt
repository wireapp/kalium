package com.wire.kalium.logic.feature.device
...
interface ResetSessionUseCase {
    suspend operator fun invoke(userId: UserId, clientId: ClientId, conversationId: ConversationId): Either<CoreFailure, Unit>
}
...
class ResetSessionUseCaseImpl internal constructor(
    ...
    override suspend operator fun invoke(userId: UserId, clientId: ClientId, conversationId: ConversationId): Either<CoreFailure, Unit> {
