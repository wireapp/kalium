...
public sealed class SyncState {
     ...
     */
    public data object Waiting : SyncState()
     ...
     */
    public data object SlowSync : SyncState()

    /**
     * Is fetching events lost while this client was offline.
     * Implies that [SlowSync] is done.
     */
    public data object GatheringPendingEvents : SyncState()
     ...
     */
    public data object Live : SyncState()

    /**
     * Sync was not completed due to a failure.
     * [retryDelay] specifies the duration in which next try will happen
     */
    public data class Failed(val cause: CoreFailure, val retryDelay: Duration) : SyncState()
}
