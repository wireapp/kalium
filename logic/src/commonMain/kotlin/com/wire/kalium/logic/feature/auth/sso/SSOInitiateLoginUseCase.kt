...
internal data class SSORedirects(val success: String, val error: String) {
    internal constructor(serverConfigId: String) : this(
    ...
    override suspend fun invoke(param: SSOInitiateLoginUseCase.Param): SSOInitiateLoginResult = with(param) {
        ...
        when (this) {
            ...
            if (it is NetworkFailure.ServerMiscommunication && it.kaliumException is KaliumException.InvalidRequestError) {
                ...
                if (error.errorResponse.code == HttpStatusCode.BadRequest.value)
                    return@fold SSOInitiateLoginResult.Failure.InvalidRedirect
                if (error.errorResponse.code == HttpStatusCode.NotFound.value)
