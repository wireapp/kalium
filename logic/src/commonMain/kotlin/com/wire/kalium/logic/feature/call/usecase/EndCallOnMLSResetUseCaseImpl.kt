...
internal class EndCallOnMLSResetUseCaseImpl(
    ...
    override suspend fun invoke(conversationId: ConversationId) = mutex.withLock {
        ...
        val hasActiveCall = when (callRepository.getCallMetadata(conversationId)?.callStatus) {
            CallStatus.STARTED, CallStatus.INCOMING, CallStatus.ANSWERED,
            CallStatus.ESTABLISHED, CallStatus.STILL_ONGOING -> true
            else -> false
        }
