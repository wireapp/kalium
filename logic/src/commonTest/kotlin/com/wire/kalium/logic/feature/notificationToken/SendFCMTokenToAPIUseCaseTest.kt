...
class SendFCMTokenToAPIUseCaseTest {
    ...
    private class Arrangement {
        ...
        private val currentClientIdProvider: CurrentClientIdProvider = mock<CurrentClientIdProvider>(mode = MockMode.autoUnit)
        private val clientRepository: ClientRepository = mock<ClientRepository>(mode = MockMode.autoUnit)
        private val notificationTokenRepository: NotificationTokenRepository = mock<NotificationTokenRepository>(mode = MockMode.autoUnit)
