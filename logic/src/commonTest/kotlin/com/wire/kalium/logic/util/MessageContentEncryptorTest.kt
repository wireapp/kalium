...
class MessageContentEncryptorTest {
    ...
    fun test() = runTest {
        // given
        given(messageRepository).function(messageRepository::getMessageById).whenInvokedWith(anything<ConversationId>(), anything<String>())
            .then {
                Either.Right(
                    Message.Regular(
                        id = "someTestId",
...
private object TestData {
    val textWithEmoji =
        ("Hello \uD83D\uDC69\u200D\uD83D\uDCBB\uD83D\uDC68\u200D\uD83D\uDC69\u200D\uD83D\uDC67!" to "2018-10-22, 3:09:29 PM") to "4f8ee55a8b71a7eb7447301d1bd0c8429971583b15a91594b45dee16f208afd5"
