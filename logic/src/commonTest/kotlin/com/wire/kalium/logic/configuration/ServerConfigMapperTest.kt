            ...
            with(serverConfig) {
                ServerConfigDTO(
                    ...
                    ServerConfigDTO.Links(
                        ...
                        links.title,
                        links.isOnPremises,
                        links.proxy?.let { ServerConfigDTO.Proxy(it.needsAuthentication, it.apiProxy) }
                    ),
            ...
            with(serverConfigEntity) {
                ServerConfig(
                    ...
                    ServerConfig.Links(
                        ...
                        links.title,
                        links.isOnPremises,
                        links.proxy?.let { ServerConfig.Proxy(it.needsAuthentication, it.apiProxy) }
                    ),
            ...
            with(serverConfig) {
                ServerConfigEntity(
                    ...
                    ServerConfigEntity.Links(
                        ...
                        links.title,
                        links.isOnPremises,
                        links.proxy?.let { ServerConfigEntity.Proxy(it.needsAuthentication, it.apiProxy) }
                    ),
