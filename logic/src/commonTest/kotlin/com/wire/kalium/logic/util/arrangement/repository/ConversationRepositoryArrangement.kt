...
internal interface ConversationRepositoryArrangement {
    ...
    suspend fun withConversationDetailsByMLSGroupId(result: Either<StorageFailure, Conversation>): ConversationRepositoryArrangement
...
internal open class ConversationRepositoryArrangementImpl : ConversationRepositoryArrangement {
    ...
    override suspend fun withConversationDetailsByMLSGroupId(result: Either<StorageFailure, Conversation>) = apply {
        coEvery {
