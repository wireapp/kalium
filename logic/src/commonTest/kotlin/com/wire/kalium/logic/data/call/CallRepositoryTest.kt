...
class CallRepositoryTest {
    ...
    @Mock
    private val callDAO = mock(classOf<CallDAO>())
...
//        callRepository.updateCallMetadataProfileFlow(CallProfile(mapOfCallProfiles))
//
//        val calls = callRepository.callsFlow()
//
//        calls.test {
...
//        callRepository.updateCallMetadataProfileFlow(CallProfile(mapOf(startedCall.conversationId.toString() to startedCall)))
//
