...
public enum class NotificationExtensionProductionGate(public val bitMask: Long) {
    ...
    EXTENSION_SAFE_AVS_BINARY(1L shl EXTENSION_SAFE_AVS_BINARY_BIT),
    POST_COMMIT_IDEMPOTENT_AVS_DISPATCH(1L shl POST_COMMIT_IDEMPOTENT_AVS_DISPATCH_BIT)
}
...
private const val EXTENSION_SAFE_AVS_BINARY_BIT = 21
private const val POST_COMMIT_IDEMPOTENT_AVS_DISPATCH_BIT = 22
