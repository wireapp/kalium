...
class MessageDAOImpl(private val queries: MessagesQueries) : MessageDAO {
    ...
    override suspend fun updateMessageVisibility(visibility: MessageEntity.Visibility, conversationId: QualifiedIDEntity, content: String?, id: String) =
        queries.updateMessageVisibility(visibility, content, id)
