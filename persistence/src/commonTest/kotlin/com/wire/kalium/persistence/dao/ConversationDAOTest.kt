...
class ConversationDAOTest : BaseDatabaseTest() {
    ...
    private companion object {
        ...
        val conversationEntity2 = ConversationEntity(
            ...
            ConversationEntity.Type.ONE_ON_ONE,
            null,
            ConversationEntity.ProtocolInfo.MLS("group2", ConversationEntity.GroupState.ESTABLISHED, 0UL, 0UL),
            lastNotificationDate = null,
        ...
        val conversationEntity3 = ConversationEntity(
            ...
            null,
            ConversationEntity.ProtocolInfo.MLS("group3", ConversationEntity.GroupState.PENDING_JOIN, 0UL, 0UL),
