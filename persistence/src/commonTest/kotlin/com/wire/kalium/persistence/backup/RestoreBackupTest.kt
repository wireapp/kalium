...
class RestoreBackupTest : BaseDatabaseTest() {
    ...
    fun givenBackupHasUniqueConversationWithCallsButFromOtherClient_whenRestoringBackup_thenNoCallsAreInserted() = runTest {
        ...
        // when
        userDatabaseBuilder.databaseImporter.importFromFile(databasePath(backupUserIdEntity), true, null)
    ...
    private fun mapFromDetailsToConversationEntity(details: ConversationViewEntity): ConversationEntity {
        return with(details) {
            ConversationEntity(
                ...
                lastModifiedInstant = lastModifiedInstant ?: Instant.fromEpochMilliseconds(MLS_DEFAULT_LAST_KEY_MATERIAL_UPDATE_MILLI),
    ...
    private suspend fun insertOverlappingConversations(amount: Int): List<ConversationEntity> {
        ...
        for (index in 1..amount) {
            ...
            val overlappingConversation = ConversationEntity(
                ...
                lastNotificationInstant = UserDatabaseDataGenerator.DEFAULT_INSTANT,
                lastModifiedInstant = UserDatabaseDataGenerator.DEFAULT_INSTANT,
                lastReadInstant = UserDatabaseDataGenerator.DEFAULT_INSTANT,
