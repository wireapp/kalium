...
interface MlsCoreCryptoContext {
    suspend fun decryptMessage(groupId: ByteArray, message: ByteArray, messageInstant: Instant): DecryptedMessageBundle
...
interface ProteusCoreCryptoContext {
    suspend fun <T : Any> decryptMessage(
        sessionId: CryptoSessionId, message: ByteArray,
