...
package com.wire.kalium.network.api.v10.unauthenticated.networkContainer
...
import com.wire.kalium.network.api.v10.unauthenticated.GetDomainRegistrationApiV10
import com.wire.kalium.network.api.v10.unauthenticated.LoginApiV10
import com.wire.kalium.network.api.v10.unauthenticated.RegisterApiV10
import com.wire.kalium.network.api.v10.unauthenticated.SSOLoginApiV10
import com.wire.kalium.network.api.v10.unauthenticated.VerificationCodeApiV10
...
class UnauthenticatedNetworkContainerV10 internal constructor(
    ...
    override val registerApi: RegisterApi get() = RegisterApiV10(unauthenticatedNetworkClient)
    override val sso: SSOLoginApi get() = SSOLoginApiV10(unauthenticatedNetworkClient)
    ...
    override val getDomainRegistrationApi: GetDomainRegistrationApi
        get() = GetDomainRegistrationApiV10(unauthenticatedNetworkClient)
}
