...
internal class AuthenticatedNetworkContainerV4 internal constructor(
    ...
    override val conversationApi: ConversationApi get() = ConversationApiV4(networkClient, ApiModelMapperImpl())
    ...
    override val selfApi: SelfApi get() = SelfApiV4(networkClient)
