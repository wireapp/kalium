...
package com.wire.kalium.network.api.v8.unauthenticated.networkContainer
...
import com.wire.kalium.network.api.v8.unauthenticated.VerificationCodeApiV8
...
class UnauthenticatedNetworkContainerV8 internal constructor(
    ...
    override val registerApi: RegisterApi get() = RegisterApiV8(unauthenticatedNetworkClient)
    override val sso: SSOLoginApi get() = SSOLoginApiV8(unauthenticatedNetworkClient)
