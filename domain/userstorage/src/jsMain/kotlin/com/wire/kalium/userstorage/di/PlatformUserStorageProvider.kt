...
public actual class PlatformUserStorageProvider : UserStorageProvider() {
    actual override fun create(
        ...
        // TODO(KALIUM-WEB): Replace placeholder JS database bootstrap with proper web persistence
        // once crypto + selected SQL driver/web storage stack are supported end-to-end.
