...
/**
 * Internal delegate that contains the common implementation for backup import functionality.
 * This class is used by platform-specific MPBackupImporter implementations.
 */
internal class BackupImporterDelegate(
    private val getUnencryptedArchiveSink: () -> Sink,
    private val unzipAllEntries: suspend () -> BackupPageStorage,
