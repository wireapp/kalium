...
/**
 * Internal delegate that contains the common implementation for backup export functionality.
 * This class is used by platform-specific MPBackupExporter implementations.
 */
internal class BackupExporterDelegate(
    private val selfUserId: BackupQualifiedId,
    private val storage: BackupPageStorage,
    private val zipEntries: (List<BackupPage>) -> Deferred<Source>,
    ...
    fun addReaction(reaction: BackupReaction) {
    ...
    suspend fun finalize(password: String, output: Sink): ExportResult {
        flushAll()
        return try {
