...
public class FileSharingConfigHandler(
    ...
    public suspend fun handle(fileSharingConfig: ConfigsStatusModel): Either<CoreFailure, Unit> {
        ...
        return userConfigRepository.setFileSharingStatus(newStatus, isStatusChanged)
    }
}
