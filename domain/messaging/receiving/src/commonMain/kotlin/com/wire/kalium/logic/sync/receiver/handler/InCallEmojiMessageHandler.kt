...
public class InCallEmojiMessageHandlerImpl public constructor(
    ...
    override suspend fun handle(message: Message.Signaling, messageContent: MessageContent.InCallEmoji) {
        inCallReactionsRepository.addInCallReaction(
            conversationId = message.conversationId,
            senderUserId = message.senderUserId,
            emojis = messageContent.emojis.keys,
        )
    }
}
