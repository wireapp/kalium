...
public interface MeetingCreateEventHandler {
    public suspend fun handle(event: Event.Meeting.Create): Either<CoreFailure, Unit>
}

public class MeetingCreateEventHandlerImpl public constructor(
