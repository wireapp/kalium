...
public interface MeetingMemberAddEventHandler {
    public suspend fun handle(event: Event.Meeting.MemberAdd): Either<CoreFailure, Unit>
}

public class MeetingMemberAddEventHandlerImpl public constructor(
