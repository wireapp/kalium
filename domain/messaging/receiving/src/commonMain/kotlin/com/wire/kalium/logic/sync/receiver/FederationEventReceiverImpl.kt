...
public class FederationEventReceiverImpl public constructor(
        ...
        connectionRepository.getFederationConnections()
            ...
            .onSuccess { conversationDetailsList ->
                conversationDetailsList?.forEach { conversationDetails ->
                    if (conversationDetails.otherUserDomain == event.domain) {
                        connectionRepository.deleteFederationConnection(conversationDetails)
                    }
                }
            }
    ...
    private suspend fun deleteMembers(
        ...
        conversationRepository.deleteFederatedMembers(userIDList, conversationID)
