...
public class CodeUpdateHandlerImpl public constructor(
    ...
    override suspend fun handle(event: Event.Conversation.CodeUpdated): Either<StorageFailure, Unit> =
        conversationEventRepository.updateGuestRoomLink(
            conversationId = event.conversationId,
            link = generateGuestLink(event.key, event.code, event.uri, accountsBaseUrl),
