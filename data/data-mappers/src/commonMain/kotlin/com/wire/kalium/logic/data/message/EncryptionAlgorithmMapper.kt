...
public class EncryptionAlgorithmMapper {
    ...
    public fun fromProtobufModel(encryptionAlgorithm: EncryptionAlgorithm?): MessageEncryptionAlgorithm? =
    ...
    public fun toProtoBufModel(messageEncryptionAlgorithm: MessageEncryptionAlgorithm?): EncryptionAlgorithm? =
