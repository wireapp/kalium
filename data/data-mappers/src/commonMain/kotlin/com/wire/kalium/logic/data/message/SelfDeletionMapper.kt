...
@InternalKaliumApi
public object SelfDeletionMapper { // TODO rename and refactor
    public fun TeamSelfDeleteTimer.toSelfDeletionTimerEntity(): SelfDeletionTimerEntity = when (this) {
    ...
    public fun SelfDeletionTimerEntity.toTeamSelfDeleteTimer(): TeamSelfDeleteTimer = when (this) {
