...
public interface MessageAttachmentMapper {
    public fun fromModelToDao(attachment: MessageAttachment): MessageAttachmentEntity?
    public fun fromProtoToModel(attachment: Attachment): MessageAttachment?
}

@InternalKaliumApi
public class MessageAttachmentMapperImpl : MessageAttachmentMapper {
...
@InternalKaliumApi
public fun MessageAttachmentEntity.toModel() =
    if (cellAsset) {
        CellAssetContent(
            id = assetId,
