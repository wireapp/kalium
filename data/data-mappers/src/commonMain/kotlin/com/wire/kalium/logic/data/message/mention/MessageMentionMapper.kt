...
public interface MessageMentionMapper {
    public fun fromDaoToModel(mention: MessageEntity.Mention): MessageMention
    public fun fromModelToDao(mention: MessageMention): MessageEntity.Mention
    public fun fromProtoToModel(mention: Mention): MessageMention?
    public fun fromModelToProto(mention: MessageMention): Mention
}

@InternalKaliumApi
public class MessageMentionMapperImpl public constructor(
...
@InternalKaliumApi
public fun MessageEntity.Mention.toModel(selfUserId: UserId?): MessageMention = MessageMention(
    start = start,
    length = length,
...
@InternalKaliumApi
public fun MessageMention.toDao(): MessageEntity.Mention = MessageEntity.Mention(
    start = start,
    length = length,
    userId = userId.toDao()
)
