...
public interface LinkPreviewMapper {
    public fun fromDaoToModel(linkPreview: MessageEntity.LinkPreview): MessageLinkPreview
    public fun fromModelToDao(linkPreview: MessageLinkPreview): MessageEntity.LinkPreview
    public fun fromProtoToModel(linkPreview: LinkPreview): MessageLinkPreview?
    public fun fromModelToProto(linkPreview: MessageLinkPreview): LinkPreview
}

@InternalKaliumApi
public class LinkPreviewMapperImpl public constructor(
    private val encryptionAlgorithmMapper: EncryptionAlgorithmMapper = EncryptionAlgorithmMapper(),
) : LinkPreviewMapper {
