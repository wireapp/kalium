...
package com.wire.kalium.network.api.v15.unauthenticated.networkContainer
...
import com.wire.kalium.network.api.v15.unauthenticated.DomainLookupApiV15
import com.wire.kalium.network.api.v15.unauthenticated.GetDomainRegistrationApiV15
import com.wire.kalium.network.api.v15.unauthenticated.LoginApiV15
...
import com.wire.kalium.network.api.v15.unauthenticated.VerificationCodeApiV15
...
class UnauthenticatedNetworkContainerV15 internal constructor(
    ...
    override val registerApi: RegisterApi get() = RegisterApiV15(unauthenticatedNetworkClient)
    override val sso: SSOLoginApi get() = SSOLoginApiV15(unauthenticatedNetworkClient)
    ...
    override val getDomainRegistrationApi: GetDomainRegistrationApi
        get() = GetDomainRegistrationApiV15(unauthenticatedNetworkClient)
}
