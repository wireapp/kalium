...
package com.wire.kalium.network.api.v14.unauthenticated.networkContainer
...
import com.wire.kalium.network.api.v14.unauthenticated.DomainLookupApiV14
import com.wire.kalium.network.api.v14.unauthenticated.GetDomainRegistrationApiV14
import com.wire.kalium.network.api.v14.unauthenticated.LoginApiV14
import com.wire.kalium.network.api.v14.unauthenticated.RegisterApiV14
import com.wire.kalium.network.api.v14.unauthenticated.SSOLoginApiV14
import com.wire.kalium.network.api.v14.unauthenticated.VerificationCodeApiV14
...
class UnauthenticatedNetworkContainerV14 internal constructor(
    ...
    override val registerApi: RegisterApi get() = RegisterApiV14(unauthenticatedNetworkClient)
    override val sso: SSOLoginApi get() = SSOLoginApiV14(unauthenticatedNetworkClient)
    ...
    override val getDomainRegistrationApi: GetDomainRegistrationApi
        get() = GetDomainRegistrationApiV14(unauthenticatedNetworkClient)
}
