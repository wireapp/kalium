...
package com.wire.kalium.network.api.v16.unauthenticated.networkContainer
...
import com.wire.kalium.network.api.v16.unauthenticated.DomainLookupApiV16
import com.wire.kalium.network.api.v16.unauthenticated.GetDomainRegistrationApiV16
import com.wire.kalium.network.api.v16.unauthenticated.LoginApiV16
import com.wire.kalium.network.api.v16.unauthenticated.RegisterApiV16
import com.wire.kalium.network.api.v16.unauthenticated.SSOLoginApiV16
import com.wire.kalium.network.api.v16.unauthenticated.VerificationCodeApiV16
...
class UnauthenticatedNetworkContainerV16 internal constructor(
    ...
    override val registerApi: RegisterApi get() = RegisterApiV16(unauthenticatedNetworkClient)
    override val sso: SSOLoginApi get() = SSOLoginApiV16(unauthenticatedNetworkClient)
    ...
    override val getDomainRegistrationApi: GetDomainRegistrationApi
        get() = GetDomainRegistrationApiV16(unauthenticatedNetworkClient)
}
