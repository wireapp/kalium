...
package com.wire.kalium.network.api.v17.unauthenticated.networkContainer
...
class UnauthenticatedNetworkContainerV17 internal constructor(
    ...
    override val registerApi: RegisterApi get() = RegisterApiV17(unauthenticatedNetworkClient)
    override val sso: SSOLoginApi get() = SSOLoginApiV17(unauthenticatedNetworkClient)
    ...
    override val getDomainRegistrationApi: GetDomainRegistrationApi
        get() = GetDomainRegistrationApiV17(unauthenticatedNetworkClient)
}
