...
class FederationErrorResponseInterceptorConflictWithMissingUsersTest {

    private val subject = FederationErrorResponseInterceptorConflictWithMissingUsers
    ...
    fun given409StatusCode_whenIntercepting_thenShouldReturnFederationConflict() = runTest {
        val expectation = FederationErrorResponse.ConflictWithMissingUsers(listOf(QualifiedID("id", "domain")))
        val body = ErrorResponseJson.validFederationConflictingBackendsWithMissingUsers(expectation).rawJson
        val responseData =
