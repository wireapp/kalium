...
class AccountsDAOImpl : AccountsDAO {
    ...
    override suspend fun currentAccount(): AccountInfoEntity? {
        TODO("Not yet implemented")
    }
    ...
    override suspend fun getAccountManagedBy(userIDEntity: UserIDEntity): ManagedByEntity? {
        TODO("Not yet implemented")
    }

    override suspend fun validAccountWithServerConfigId(): Map<UserIDEntity, ServerConfigEntity> {
        TODO("Not yet implemented")
    }
